...
const Content = ({ onChange, stars }) => (
    ...
    >
        <div css={{ flex: 1, [largeDevice]: { paddingRight: 30 } }}>
            ...
            >
                A flexible and beautiful Select Input control for ReactJS with multiselect,
                autocomplete, async and creatable support.
            </p>
            <div css={{ flex: 1, alignItems: "center" }}>
                <GitHubButton count={stars} repo="https://github.com/jedwatson/react-select" />
                <TwitterButton />
            </div>
        </div>
        <div
